# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2020-05-22 20:46
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('checkout', '0002_auto_20200522_1004'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.IntegerField(blank=True, choices=[(0, 'Agardando Pagamento'), (1, 'Compra Concluída'), (2, 'Compra Cancelada')], default=0, verbose_name='Situação')),
